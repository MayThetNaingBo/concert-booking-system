...
>
  ...
  {concert.startTime && (
    <div style={{marginBottom:"20px"}}>
      ...
      <div>{concert.startTime}</div>
    </div>
  )}

  <div style={{marginBottom:"30px"}}>
    <div style={{fontSize:"12px",opacity:0.6,marginBottom:"4px"}}>📍 VENUE</div>
  ...
  >
    ...
    >
      VIEW SEATS →
            ...
            <h2 style={{ fontFamily: "Bebas Neue", fontSize: "32px" }}>
              {concert.artist}
            </h2>
            ...
            <p style={{ marginTop: "15px" }}>📍 {concert.venue}</p>
