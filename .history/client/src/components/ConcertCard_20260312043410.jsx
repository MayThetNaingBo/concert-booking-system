          ...
          >
            ...
            <div style={{ flex: 1, padding: "36px 40px", position: "relative" }}>
              ...
              <div style={{ display: "flex", gap: "24px", marginBottom: "24px", flexWrap: "wrap" }}>
                <div>
                  <div style={{fontSize:"11px",opacity:0.5,marginBottom:"4px",letterSpacing:"0.1em"}}>📅 DATE</div>
                ...
                {concert.startTime && (
                  <div>
                    <div style={{fontSize:"11px",opacity:0.5,marginBottom:"4px",letterSpacing:"0.1em"}}>🕒 TIME</div>
              ...
              <div style={{marginBottom:"30px"}}>
                <div style={{fontSize:"11px",opacity:0.5,marginBottom:"4px",letterSpacing:"0.1em"}}>📍 VENUE</div>
