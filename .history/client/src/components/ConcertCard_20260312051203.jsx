  ...
  return (
    <>
      <style>{`
        ...
        .concert-card:hover .concert-card-body {
        ...
        .concert-card:hover .concert-card-preview {
          opacity: 1;
        }
        ...
        <div className="concert-card-body">
          ...
          <div className="concert-card-meta">
            ...
            <div>
              ...
              <div className="concert-card-artist">{concert.artist}</div>
          ...
          <div className="concert-card-preview">
            {concert.description?.slice(0, 90)}...
          </div>
      ...
      {/* MODAL (your existing modal stays unchanged) */}
      {showModal && (
        ...
        >
          ...
          {/* Keep your modal exactly as you already wrote */}
