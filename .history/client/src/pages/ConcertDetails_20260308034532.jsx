...
const GAP_DEG    = 50;
const ARC_DEG    = 360 - GAP_DEG;             // 310°
const GAP_CENTER = 90;
const GAP_START  = GAP_CENTER + GAP_DEG / 2;  // 115°
const GAP_END    = GAP_CENTER - GAP_DEG / 2 + 360; // 425°
const SEAT_GAP   = 8;
...
const OUTER_R        = 487;
const PADDING        = 60;   // extra room for rotated tile corners
