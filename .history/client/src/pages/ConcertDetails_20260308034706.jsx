...
const GAP_DEG    = 30;                        // smaller gap = more seats on right
const ARC_DEG    = 360 - GAP_DEG;             // 330°
const GAP_CENTER = 90;
const GAP_START  = GAP_CENTER + GAP_DEG / 2;  // 105°
const GAP_END    = GAP_CENTER - GAP_DEG / 2 + 360; // 435°
const SEAT_GAP   = 7;
...
const ZONES = [
  ...
  },
  {
    ...
    rows: [
      { row: "I", radius: 466, tileW: 26, tileH: 21 },
      { row: "J", radius: 494, tileW: 26, tileH: 21 },
      { row: "K", radius: 522, tileW: 26, tileH: 21 },
      { row: "L", radius: 550, tileW: 26, tileH: 21 },
      { row: "L2", radius: 578, tileW: 26, tileH: 21 },
      { row: "L3", radius: 606, tileW: 26, tileH: 21 },
    ],
  ...
  },
  {
    ...
    rows: [
      { row: "M", radius: 644, tileW: 25, tileH: 20 },
      { row: "N", radius: 672, tileW: 25, tileH: 20 },
      { row: "O", radius: 700, tileW: 25, tileH: 20 },
      { row: "P", radius: 728, tileW: 25, tileH: 20 },
      { row: "Q", radius: 756, tileW: 25, tileH: 20 },
    ],
