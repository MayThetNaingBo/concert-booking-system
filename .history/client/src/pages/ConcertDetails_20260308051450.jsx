...
const ZONES = [
  ...
  },
  {
    ...
    rows: [
      { row: "E", seats: 38, radius: 292 },
      { row: "F", seats: 38, radius: 322 },
      { row: "G", seats: 38, radius: 352 },
      { row: "H", seats: 38, radius: 382 },
      { row: "I", seats: 38, radius: 412 },
      { row: "J", seats: 38, radius: 442 },
      { row: "J2", seats: 38, radius: 472 },
      { row: "J3", seats: 38, radius: 502 },
    ],
  ...
  },
  {
    ...
    rows: [
      { row: "K", seats: 38, radius: 546 },
      { row: "L", seats: 38, radius: 576 },
      { row: "M", seats: 38, radius: 606 },
          ...
          >
            ...
            {seats.map(seat => {
              ...
              return (
                ...
                >
                  {isSel && (
                    <rect x={x - TILE_W/2 - 3} y={y - TILE_H/2 - 3}
                  ...
                  {/* Shine */}
                  <rect x={x - TILE_W/2 + 2} y={y - TILE_H/2 + 2}
