    ...
    <>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .booking-btn:not(:disabled) { color:#050508; background:linear-gradient(135deg,#e8ff47, #47eaff); cursor:pointer; box-shadow:0 4px 20px rgba(53, 222, 245, 0.25); }
        .booking-btn:not(:disabled):hover { box-shadow:0 6px 28px rgba(71, 145, 255, 0.42); transform:translateY(-1px); }
      ...
      <div className="cd-page">
        ...
        <div className="legend">
          ...
          <div className="legend-item">
            <div className="legend-sq" style={{ background:"#47eaff", border:"1px solid #47eaff" }}/>
            Your Selection
          </div>
        </div>
      </div>
