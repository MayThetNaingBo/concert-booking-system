    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Zone legend panel — bottom-left of the SVG ── */
        .zone-legend-panel {
          position: absolute;
          bottom: 54px;
          left: max(1.5rem, calc(50% - 500px + 1.5rem));
          display: flex;
          flex-direction: column;
          gap: 0.38rem;
        ...
        /* ── Bottom legend strip (unavailable / selection) ── */
        .legend {
          display: flex;
          justify-content: center;
          flex-wrap: wrap;
      ...
      <div className="cd-page">
        ...
        {/* ── Centered info bar above the map ── */}
        ...
        {/* ── Map wrapper (position: relative so legend can anchor) ── */}
        <div className="map-outer">
          ...
          {/* ── Zone legend panel — bottom-left of the SVG area ── */}
        ...
        {/* Bottom legend strip — kept for smaller screens / overflow */}
