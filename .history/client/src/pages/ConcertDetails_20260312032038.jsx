    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Zone legend panel — below SVG, left side ── */
        .zone-legend-wrap {
          display: flex;
          justify-content: flex-start;
          padding: 0.6rem 0 0.4rem max(1.5rem, calc(50% - 500px + 1.5rem));
        }
      ...
      <div className="cd-page">
        ...
        {/* ── Zone legend panel — below SVG, left-aligned, never overlaps seats ── */}
