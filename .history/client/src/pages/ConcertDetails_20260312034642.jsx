...
import { useNavigate } from "react-rouater-dom";
...
const availableSeats = totalSeats - bookedSeats;
  ...
  // Build a quick lookup map from seatNumber -> seat object
  const seatMap = {};
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Zone legend — horizontal bar, shifted right ── */
        .zone-legend-wrap {
          display: flex;
          justify-content: center;
          margin-bottom: 1rem;
      ...
      <div className="cd-page">
        ...
        {/* ── Horizontal zone legend bar ── */}
        <div className="zone-legend-wrap">
          <div className="zone-legend-panel">
            <div className="zone-legend-title">Zones &amp; Pricing</div>
            {ZONES.map((z, i) => (
              <>
                <div key={z.id} className="zone-legend-row">
                  <span className="zone-legend-swatch" style={{ background: z.color.base, border: `1px solid ${z.color.border}` }} />
                  <span>{z.label}</span>
                  <span className="zone-legend-price" style={{ color: z.color.base }}>SGD {z.price}</span>
                </div>
                {i < ZONES.length - 1 && <div className="zone-legend-divider" />}
              </>
            ))}
            <div className="zone-legend-divider" />
