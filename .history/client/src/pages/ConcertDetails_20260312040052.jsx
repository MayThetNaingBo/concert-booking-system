...
return;
  ...
  style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 11, letterSpacing: "0.2em" }}  // was 9
>AISLE</text>
...
>{z.id === "VIP" ? "✦ VIP" : z.id}</text>
  ...
  style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 13, letterSpacing: "0.25em" }}  // was 11
>▲</text>
<text
  x={SVG_W / 2} y={SVG_H - 10}
  textAnchor="middle" fill="rgba(255,255,255,0.45)"   // was 0.15
  style={{ fontFamily: "'Outfit',sans-serif", fontSize: 10, fontWeight: 700, letterSpacing: "0.22em" }}  // was 8
>MAIN ENTRANCE</text>
